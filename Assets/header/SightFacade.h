...
@interface SightFacade : MMService <IMMNewSessionMgrExt, SightMomentDraftTipsViewControllerDelegate, MMService, IMsgExt, SightCaptureDelegate, MMovieCompressorDelegate>
{
...
- (void)compressVideoWithMMAsset:(id)arg1 scene:(unsigned long long)arg2 withCompletion:(CDUnknownBlockType)arg3;
