...
@class NSArray, NSMutableArray, NSMutableDictionary, NSString, SnsObject, WCActionInfo, WCAdvertiseInfo, WCAppInfo, WCContentItem, WCLocationInfo, WCMusicInfo, WCObjectOperation, WCRecommendInfo, WCRedEnvelopesInfo, WCRedEnvelopesRewardInfo, WCStreamVideoInfo, WCWeAppInfo;
