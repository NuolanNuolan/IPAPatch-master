...
@interface MMMusicPageView : UIView <UITableViewDelegate, UITableViewDataSource, MMImageLoaderObserver, MMWebImageViewDelegate, MMCopyLabelDelegate, MMMusicPlayerExt>
{
