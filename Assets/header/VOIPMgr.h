...
@interface VOIPMgr : MMService <AVVideoDataSource, AUAudioDataSource, IAUAudioDeviceExt, ISysCallCheckExt, IVOIPSyncExt, PBMessageObserverDelegate, INetworkStatusMgrExt, CNetworkStatusExt, MMService, AVVideoDeviceSessionDelegate>
{
    ...
    struct T_RtcpInfoP2S mstRtcpInfoP2S;
    struct T_HeadRtcpInfo mstHeadRtcpInfo;
    struct T_AudioRtcpInfoP2S mstAudioRtcpInfoP2S;
    struct T_VideoRtcpInfoP2S mstVideoRtcpInfoP2S;
    struct T_LinkRtcpInfoP2S mstLinkRtcpInfoP2S;
    struct T_RtcpInfoS2P mstRtcpInfoS2P;
    struct T_AudioRtcpInfoS2P mstAudioRtcpInfoS2P;
    struct T_VideoRtcpInfoS2P mstVideoRtcpInfoS2P;
    struct T_LinkRtcpInfoS2P mstLinkRtcpInfoS2P;
...
@property struct T_RtcpInfoS2P mstRtcpInfoS2P; // @synthesize mstRtcpInfoS2P;
@property struct T_RtcpInfoP2S mstRtcpInfoP2S; // @synthesize mstRtcpInfoP2S;
