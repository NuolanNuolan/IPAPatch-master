...
@property(retain, nonatomic) NSString *qqnickName; // @dynamic qqnickName;
@property(retain, nonatomic) NSString *qqremarkName; // @dynamic qqremarkName;
@property(nonatomic) unsigned int qquin; // @dynamic qquin;
...
@property(nonatomic) unsigned int weixinStatus; // @dynamic weixinStatus;
