...
@class EmoticonStoreItem, EmoticonStoreReportInfo, EmotionProgressView, MMWebImageView, NSString, UIActivityIndicatorView, UIButton, UILabel;
...
@property(retain, nonatomic) UIButton *m_rewardButton; // @synthesize m_rewardButton=_m_rewardButton;
...
@property(retain, nonatomic) UIButton *m_downloadedView; // @synthesize m_downloadedView;
