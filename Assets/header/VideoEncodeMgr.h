...
- (unsigned int)estimatedSizeWithVideoPath:(id)arg1;
...
- (id)getParamsForChatAlbumVideoSize:(struct CGSize)arg1 duration:(double)arg2 fps:(float)arg3 videoBitrate:(float)arg4;
- (id)getParamsForMomentAlbumVideoSize:(struct CGSize)arg1 duration:(double)arg2 fps:(float)arg3 videoBitrate:(float)arg4;
