...
#import "VoipCSDelegate-Protocol.h"

@class NSString;

@interface WAJSEventHandler_makeVoIPCall : WAJSEventHandler_BaseEvent <VoipCSDelegate, IBrandAttrMgrExt>
{
