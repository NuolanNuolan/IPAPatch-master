...
@class AVAudioPlayer, AVCaptureVideoPreviewLayer, CContact, CMessageWrap, MMTimer, MultiTalkHDHeadView, NSString, UIAlertView, UIButton, UIImageView, UILabel, VideoVoipTalkingView, VoipMinimizeReportObject, WavAudioPlayer;
