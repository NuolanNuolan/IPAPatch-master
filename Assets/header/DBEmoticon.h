...
@property(nonatomic) unsigned int indexInPack; // @synthesize indexInPack;
...
- (const WCDBCondition_22fabacd *)db_extInfo;
- (const WCDBCondition_c6db074e *)db_indexInPack;
- (const WCDBCondition_c6db074e *)db_extFlag;
- (const WCDBCondition_c6db074e *)db_lastUsedTime;
