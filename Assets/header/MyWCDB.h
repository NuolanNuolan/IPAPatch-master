...
- (id)getDataItemListFromTable:(id)arg1 afterItemID:(id)arg2 limit:(unsigned int)arg3;
...
- (id)getRawWCMessagesForClearLimit:(unsigned int)arg1 unReadOnly:(_Bool)arg2;
