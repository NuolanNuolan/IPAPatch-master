...
@class APAccess, APAuth, APCheck, APCheckPwd, APPortal, APPortal33, CContact, MMWebViewController, NSMutableDictionary, NSString, PublicWifiCache, PublicWifiGetA8KeyLogic, PublicWifiNetworkLogicMgr, PublicWifiPCLogic, PublicWifiReportLocationLogic, PublicWifiReportQuality, PublicWifiScanListLogic;
