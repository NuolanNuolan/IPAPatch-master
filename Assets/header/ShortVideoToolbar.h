...
@class EditImageAttr, EditImageIntialView, MMCircularProgressView, MMLoadingView, MMSightRecordView, NSMutableArray, NSString, ShortVideoToolbarPreviewView, SightCameraTopToolView, UIButton, UIImage, UIImageView, UILabel, UIView;
@protocol ShortVideoBarDelegate, SightPreviewView;

@interface ShortVideoToolbar : MMUIView <UIAlertViewDelegate, MonoServiceLogicExt, UITextFieldDelegate, EditImageInitialViewDelegate>
{
    _Bool m_isActive;
    double m_topPositon;
