...
@class AVAudioPlayer, AVCaptureVideoPreviewLayer, CContact, MMHDHeadImageView, MMTimerLabel, MMTipsView, MultiTalkHDHeadView, NSString, SmallCameraView, UIButton, UIImageView, UILabel, UIView, VOIPVideoRender, VOIPVideoToVoiceView, VoipDescriptionButton;
