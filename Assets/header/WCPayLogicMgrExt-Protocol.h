...
- (void)onNotifyOfflinePayRealNameBlock:(NSError *)arg1;
...
- (void)OnQueryOrderWhenPaidError:(NSError *)arg1 isDelay:(_Bool)arg2 queryOrderInterval:(long long)arg3 queryOrderCount:(long long)arg4;
