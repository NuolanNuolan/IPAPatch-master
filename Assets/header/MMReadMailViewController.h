...
@class CAttach, CMail, CMessageWrap, MMLoadingView, MMTableView, NSMutableArray, NSString, PushMailWrap, UIButton, UILabel, UIView, WebViewJSLogicImpl, YYUIWebView;
@protocol MMReadMailViewDelegate;

@interface MMReadMailViewController : MMWebViewController <UITableViewDelegate, UITableViewDataSource, UIWebViewDelegate, IMsgExt, IQQMailExt, WCActionSheetDelegate, UIAlertViewDelegate, MailAttachDelegate, UIScrollViewDelegate>
{
    MMTableView *_tableView;
    YYUIWebView *_webView;
