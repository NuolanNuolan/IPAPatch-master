...
#import "WXGestureDelegate-Protocol.h"
#import "contactInfoDelegate-Protocol.h"
#import "tableViewDelegate-Protocol.h"

@class BadRoomLogicController, BaseChatViewModel, CMessageWrap, FirstUnReadTipView, MMInputToolView, MMLoadingView, MMMultiSelectToolView, MMScrollActionSheet, MMTableView, MMTimer, MMUIWindow, MsgImgFullScreenWindow, MsgSearchHelper, MultiTalkTipsView, NSMutableArray, NSString, ShareMessageConfirmLogicHelper, StreamVoiceInputViewController, TipsView, TrackRoomTipsView, UIActivityIndicatorView, UIBarButtonItem, UIImageView, UIView, WXGesture;
