...
@class CContact, DeepLinkBitSet, GeneralControlBitSet, JSAPIPermissionBitSet, JumpEmoticonDetailCgi, NSData, NSDictionary, NSMutableDictionary, NSString, UIViewController;
...
- (void)showContactInfoView:(id)arg1 QRCodeScene:(int)arg2;
- (void)doSearchContact:(id)arg1 FromScene:(unsigned int)arg2 SearchScene:(unsigned int)arg3 resultString:(id)arg4 subScene:(unsigned int)arg5;
- (void)doSearchContact:(id)arg1 FromScene:(unsigned int)arg2 SearchScene:(unsigned int)arg3;
- (void)doSearchContact:(id)arg1 SearchScene:(unsigned int)arg2;
