...
@class AVAudioPlayer, AVCaptureVideoPreviewLayer, CContact, MMHDHeadImageView, MMTimerLabel, MMTipsView, NSString, SmallCameraView, UIButton, UIImageView, UILabel, UIView, VOIPVideoRender, VOIPVideoToVoiceView, VoipDescriptionButton;
