...
@class EditImageIntialView, EditImageLogicController, MMLoadingView, MultiImageScrollView, NSDictionary, NSMutableArray, NSString, UIActivityIndicatorView, UIButton, UILabel, UIView;
