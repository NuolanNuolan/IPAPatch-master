...
@class AppInnerJumpItem, AppProductItem, AppTVItem, CMessageWrap, CardTicketItem, EmoticonSharedItem, EmotionDesignerSharedItem, EmotionPageSharedItem, FavoritesItem, GiftCardItem, HardWareItem, MMWCPushInfo, MallProductItem, MessageExpItem, NSArray, NSMutableDictionary, NSString, WAAppMsgItem, WCCanvasPageItem, WCPayInfoItem, iWatchAppMsgItem;
...
@property(retain, nonatomic) MMWCPushInfo *m_oWebcachePushInfo; // @synthesize m_oWebcachePushInfo;
