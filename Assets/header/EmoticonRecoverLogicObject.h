...
@class EmoticonDownloadMd5ListCgi, EmoticonDownloadProxy, NSObject, NSString;
@protocol EmoticonRecoverLogicObjectDelegate, OS_dispatch_queue;
...
@interface EmoticonRecoverLogicObject : MMObject <EmoticonDownloadMd5ListCgiDelegate, EmoticonDownloadProxyDelegate>
{
    ...
    NSObject<OS_dispatch_queue> *_m_emoticonOperationQueue;
}

@property(retain, nonatomic) NSObject<OS_dispatch_queue> *m_emoticonOperationQueue; // @synthesize m_emoticonOperationQueue=_m_emoticonOperationQueue;
